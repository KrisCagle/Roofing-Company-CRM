      ...
      documents.map((document) => (
        ...
        >
          ...
          <div className="mt-3 flex flex-wrap gap-4 text-xs text-slate-500">
            {document.fileName && <span>File: {document.fileName}</span>}
            {document.imageName && <span>Photo: {document.imageName}</span>}
          </div>
        </div>
      ))
    )}
  ...
  <div className="mt-6 border-t border-slate-200 pt-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <label
            ...
            className="flex min-h-[92px] cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 text-center transition hover:bg-slate-100"
          >
            <span className="rounded-md bg-slate-800 px-4 py-2 text-sm font-medium text-white">
              Choose File
            </span>
            <span className="mt-3 text-xs text-slate-500">
              {documentForm.fileName || "No file chosen"}
            </span>
          </label>
        </div>
        ...
        <div>
          ...
          >
            ...
            <span className="mt-3 text-xs text-slate-500">
              {documentForm.imageName || "No photo chosen"}
            </span>
          </label>
        </div>
      </div>
    ...
    <div className="mt-5 flex justify-end">
      <button
        ...
        className="rounded-md bg-slate-800 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
      >
